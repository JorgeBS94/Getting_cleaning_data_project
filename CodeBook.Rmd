...
1. We have loaded into R the training and test data, as well as their respective labels, the feature vector and the data about the subjects performing the exercises.
...
6. Finally, we have created a tidy dataset by grouping our previous data by subject and by activity label, computing the mean value.
